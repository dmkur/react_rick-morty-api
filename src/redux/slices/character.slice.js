...
const characterById = createAsyncThunk(
  ...
  async ({ id }, { rejectWithValue }) => {
    try {
      ...
      // console.log(data, "from characterSlice/characterById");
      return data;
    } catch (e) {
      return rejectWithValue(e.response.data);
    }
...
const characterEpisodes = createAsyncThunk(
  ...
  async ({ ids }, { rejectWithValue }) => {
    try {
      // console.log(ids, "from characterSlice/characterEpisodes");
      const { data } = await characterService.getCharacterEpisodes(ids);
      // console.log(data, "from characterSlice/characterEpisodes");
      return data;
    } catch (e) {
      return rejectWithValue(e.response.data);
    }
